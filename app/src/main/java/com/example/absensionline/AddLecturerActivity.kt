    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerButton!!.setOnClickListener { // TODO Auto-generated method stub
            ...
            if (TextUtils.isEmpty(first_name)) {
                ...
                val facultyBean = LecturerBean()
                facultyBean.setLecturer_firstname(first_name)
                facultyBean.setLecturer_lastname(last_name)
                facultyBean.setLecturer_mobilenumber(phone_no)
                facultyBean.setLecturer_address(address)
                facultyBean.setLecturer_username(userName)
                facultyBean.setLecturer_password(passWord)
