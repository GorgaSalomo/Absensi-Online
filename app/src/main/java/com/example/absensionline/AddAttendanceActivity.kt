...
class AddAttendanceActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        studentBeanList = (this@AddAttendanceActivity.applicationContext as ApplicationContext).getStudentBeanList()
        ...
        listView!!.onItemClickListener = OnItemClickListener { arg0, arg1, arg2, arg3 ->
            ...
            val studentBean: StudentBean = studentBeanList!![arg2]
